...
<template>
    <nav class="navbar navbar-expand-lg bg-dark ">
        <div class="container-fluid ">
            <a class="navbar-brand text-light" href="#">Electric Scooter</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown" :class="{ 'nav-item-active': $route.path.startsWith('/scooters') }">
                        ...
                        <ul class="dropdown-menu bg-dark">
                          ...
                          <li><router-link exact-active-class="dropdown-item-active" :to=" { name: 'scooterOverview37c' }" class="dropdown-item">Scooters details (Cached-backend)</router-link></li>
