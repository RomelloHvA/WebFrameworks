...
export class Scooter {
   ...
   static Status = {
    ...
    static async createSampleScooter(pId = 0){
        let id = pId;
        let tag = this.#createRandomTag(8);
        let status = this.#createRandomStatus();
        let gpsLocation = this.#createRandomGPSLocation();
     ...
     */
    static #createRandomGPSLocation(){
